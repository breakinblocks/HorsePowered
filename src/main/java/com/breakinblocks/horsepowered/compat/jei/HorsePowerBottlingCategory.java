...
public class HorsePowerBottlingCategory implements IRecipeCategory<BottlingRecipe> {
    ...
    public static final ResourceLocation UID = new ResourceLocation(Reference.MODID, "bottling");
    ...
    public HorsePowerBottlingCategory(IGuiHelper guiHelper) {
        ...
        this.title = Component.translatable("gui." + Reference.MODID + ".jei.bottling");
    }
