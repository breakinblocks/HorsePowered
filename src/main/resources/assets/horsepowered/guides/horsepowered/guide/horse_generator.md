...
- Mining the generator with a stone-tier or better pickaxe preserves its stored charge in `BlockEntityTag` on the dropped item, so you can move it without losing power
